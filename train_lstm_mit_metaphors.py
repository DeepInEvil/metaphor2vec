...
from keras.layers import Dense, Dropout, Embedding, Conv1D, GlobalAveragePooling1D, LSTM
...
def lstm_model(embedding_weights, cv_dat, max_len):
    ...
    print merge_pooling
    """ 
    lstm_layer = LSTM(128, return_sequences=False)(embedded_layer_body)
    hidden_layer = Dense(1200, activation='tanh', kernel_initializer="glorot_uniform")(lstm_layer)
